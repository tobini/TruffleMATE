...
public abstract class PerformWithArgumentsInSuperclassPrim extends QuaternaryExpressionNode {
  ...
  public final Object doSAbstractObject(final VirtualFrame frame,
    ...
    return call.call(frame, SInvokable.getCallTarget(invokable), SArguments.createSArguments(SArguments.getEnvironment(frame), SArguments.getExecutionLevel(frame), mergeReceiverWithArguments(receiver, argArr)));
  }
